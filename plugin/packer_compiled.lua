...
_G.packer_plugins = {
  LuaSnip = {
    loaded = true,
    path = "/Users/hungbui/.local/share/nvim/site/pack/packer/start/LuaSnip",
  ...
  ["session-lens"] = {
    ...
    loaded = true,
    path = "/Users/hungbui/.local/share/nvim/site/pack/packer/start/session-lens",
  ...
  ["vim-vsnip"] = {
    loaded = true,
    path = "/Users/hungbui/.local/share/nvim/site/pack/packer/start/vim-vsnip",
